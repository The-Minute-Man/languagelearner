  ...
  return (
    <div className="app-layout">
      ...
      <main className="main-content">
        ...
        {activeTab === 'learn' && (
          <LearnTab
            activeDeck={activeDeck} answer={answer} cards={cards} completed={completed} correct={correct} dispatchLearn={dispatchLearn} formatTime={formatTime} handleMatchingCardClick={handleMatchingCardClick} handleMcqSelect={handleMcqSelect} handleTfSelect={handleTfSelect} handleTypeSubmit={handleTypeSubmit} isCorrect={isCorrect} isInClass={isInClass} isMatched={isMatched} isMismatched={isMismatched} isSelected={isSelected} isTarget={isTarget} key={key} learnState={learnState} matched={matched} matchingBoard={matchingBoard} matchingCardKey={matchingCardKey} mcOptions={mcOptions} options={options} payload={payload} prompt={prompt} selected={selected} session={session} title={title} type={type}
          />
        )}
        ...
        {activeTab === 'settings' && (
          <SettingsTab
            DEFAULT_CLASS_SLUG={DEFAULT_CLASS_SLUG} activeClass={activeClass} activeClassId={activeClassId} availableClasses={availableClasses} classActionLoading={classActionLoading} current={current} darkMode={darkMode} isAdmin={isAdmin} isInClass={isInClass} joinClass={joinClass} key={key} leaveClass={leaveClass} profileLoading={profileLoading} rejoinDefaultClass={rejoinDefaultClass} setDarkMode={setDarkMode} title={title} type={type}
          />
        )}
